...
int main(int argc, char *argv[]) {
    ...
    webkit_settings_set_enable_developer_extras(settings, TRUE); // útil para depurar WebApps
    webkit_settings_set_enable_page_cache(settings, TRUE);
    webkit_settings_set_enable_site_specific_quirks(settings, TRUE); // mejora compatibilidad con PWAs
